        ...
        <main className="p-8 relative">
          ...
          <div className="grid gap-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {statistics.map((stat) => (
                <Card key={stat.title} className="p-6 bg-gray-900/30 border-gray-800/50 backdrop-blur-xl">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <Card className="p-6 bg-gray-900/30 border-gray-800/50 backdrop-blur-xl">
                <div className="flex items-center justify-between mb-6">
                  <h2 className="text-xl font-semibold bg-gradient-to-r from-white via-blue-400 to-purple-500 bg-clip-text text-transparent">Income Overview</h2>
                  <Button variant="outline" size="sm" className="border-gray-700/50 text-gray-400 hover:text-white hover:border-primary/50">
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-center justify-between p-4 bg-gray-800/30 rounded-lg">
                    <div>
                      ...
                      <p className="text-2xl font-bold text-white">$415</p>
                    </div>
                    <div className="flex items-center gap-1 text-green-400">
                      <TrendingUp className="h-4 w-4" />
                  ...
                  <div className="flex items-center justify-between p-4 bg-gray-800/30 rounded-lg">
                    <div>
                      <p className="text-gray-400 text-sm">Best Performing Asset</p>
